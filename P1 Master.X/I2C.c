...
//*****************************************************************************
// Función de espera: mientras se está iniciada una comunicación,
// está habilitado una recepción, está habilitado una parada
// está habilitado un reinicio de la comunicaci?n, est? iniciada
